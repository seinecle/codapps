...
//ST: !
What they probably did is that they used a loop to create the ballons:
...
We need something to handle our 20,000 ballons. Like a bag or a box where they would be stored and available for use. This is called a Collection.
